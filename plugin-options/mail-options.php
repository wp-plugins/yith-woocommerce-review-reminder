...
$item_link = !defined( 'YWRR_PREMIUM' ) ? '' : array(
    ...
    'type'    => 'select',
    'desc'    => __( 'Set the destination you want to show in the email', 'ywrr' ),
    'options' => array(
        'product' => __( 'Product page', 'ywrr' ),
        'review'  => __( 'Default WooCommerce Reviews Tab', 'ywrr' ),
        'custom'  => __( 'Custom Anchor', 'ywrr' ),
    ),
    'default' => 'product',
...
$item_link_hash = !defined( 'YWRR_PREMIUM' ) ? '' : array(
    'name' => __( 'Set Custom Anchor', 'ywrr' ),
    'type' => 'text',
    'desc' => '',
